...
namespace CodeEndeavors.ServiceHost.Extensions
{
    public static class ReflectionExtensions
    {
        ...
        private static readonly Dictionary<string, IEnumerable<Assembly>> _cachedAssemblies = new Dictionary<string, IEnumerable<Assembly>>();
        ...
        public static T GetInstance<T>(this string typeName, string assemblyPath = null)
        {
            ...
            if (obj == null)
                throw new Exception(string.Format("Unable to create a valid instance of {0} from type: {1}", typeof(T).ToString(), typeName));
            return obj.ToType<T>();
        }
