...
{
    public class SwaggerPlugin : BasePlugin, IServiceHostPlugin
    {
        public int? Priority
        {
            get { return 70; }
        ...
        {
            var thisAssembly = typeof(SwaggerPlugin).Assembly;

            var helpUrl = GetConfigSetting("Help.Url", "help");
            ...
            config
                .EnableSwagger("docs/{apiVersion}/" + helpUrl, c =>
                {
                    ...
                    //
                    var dir = new DirectoryInfo(Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, @"bin"));

                    foreach (var file in dir.GetFiles(@"*.api.xml"))
